...
const BrowseByCategory: React.FC = () => {
  ...
  const iconsMap: Record<number, { imageUrl: string, icon: JSX.Element }> = {
      ...
      2: {
        imageUrl:"https://blog.ipleaders.in/wp-content/uploads/2020/09/house-and-key-on-wooden-table-on-sunlight-background-building-concept-concept-of-selling-real-estate-1138190269-563869f4765c46a3a194e83d80ca61eb.jpg",
        icon: <FaCar size={40} />, 
      },
      3: {
      ...
      4: {
        imageUrl:"https://th.bing.com/th/id/OIP.OH7KbfjqrFLWJsSNRRudxAHaHa?w=626&h=626&rs=1&pid=ImgDetMain",
        icon: <FaUtensils size={40} />,
      },
      5: {
        imageUrl:"https://conteudos.quintoandar.com.br/wp-content/uploads/2023/03/GettyImages-1409298953.jpg",
        icon: <FaShoppingCart size={40} />, 
      },
      6: {
        imageUrl:"https://www.financialexpress.com/wp-content/uploads/2023/02/real-estate-Mumbai-2.jpg",
